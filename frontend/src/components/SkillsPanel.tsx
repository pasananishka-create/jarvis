...
const SKILLS: SkillDef[] = [
  ...
  { name: "files.upload", description: "Upload files from your device", icon: "📎", mode: "both" },
  { name: "files.pdf.extract", description: "Extract text from PDF files", icon: "📃", mode: "backend" },
  { name: "files.pdf.edit", description: "Edit PDFs — add/replace text, add/delete pages", icon: "📝", mode: "backend" },
  { name: "files.pdf.merge", description: "Merge multiple PDFs into one", icon: "📑", mode: "backend" },
  { name: "files.pdf.split", description: "Split PDFs into individual pages", icon: "✂️", mode: "backend" },
